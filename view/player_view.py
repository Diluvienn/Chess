...
def get_player_info_from_user():
    ...
    while True:
        ...
        if all(char.isalpha() or char == '-' for char in firstname):
            ...
            print("\033[91mLe prénom ne peut contenir que des lettres et des tirets. Veuillez réessayer.\033[0m")
    ...
    while True:
        ...
        if lastname.replace(' ', '').isalpha():
            ...
            print("\033Le nom de famille ne peut contenir que des lettres et des espaces. Veuillez réessayer.\033[0m")
    ...
    while True:
        ...
        if validate_date_format(birth):
            ...
            print("\033Format de date invalide. Veuillez utiliser le format 'DD-MM-YYYY'. Veuillez réessayer.\033[0m")
    ...
    while True:
        ...
        if validate_national_chess_id_format(national_chess_id):
            ...
            print("\033Format d'identifiant national invalide. Veuillez utiliser le format 'AB12345'.\033[0m")
